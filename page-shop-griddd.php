...
?>
<main id="main" data-barba="container" data-barba-namespace="shop" class="shop mt6">
	...
	<section class="shop-container overflow-hidden" header-color="white">
			...
			<?php $all_categories = get_categories( $args );
				...
				<?php if($cat->count > 0 && !($category_id === 21) ) : ?>
					<div class="cat-header mv6 <?php echo $cat->name; ?>">
							<?php if ($image) : ?>
								<div class="cat-logo center <?php if($cat->name === "Mártir") : ?> martir-logo <?php endif;?>">
